                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="barcodeModal-{{ $item->kode_barang }}" tabindex="-1"
                                                aria-labelledby="barcodeModalLabel-{{ $item->kode_barang }}" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="barcodeModalLabel-{{ $item->kode_barang }}">
                                                            ...
                                                            @if($item->barcode && Storage::disk('public')->exists($item->barcode))
                                                                <div class="mb-3">
                                                                    <img src="{{ '/storage/' . $item->barcode }}"
                                                                        alt="Barcode {{ $item->kode_barang }}" class="img-fluid">
                                                                </div>
                                                                <div class="mt-2">
