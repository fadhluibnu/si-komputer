                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_komputer') is-invalid @enderror" id="nama_komputer" name="nama_komputer" value="{{ old('nama_komputer') }}" placeholder="Contoh: PC-ADMIN-01">
                                @error('nama_komputer')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @else
